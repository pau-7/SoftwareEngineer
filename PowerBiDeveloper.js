...
const setDefaultValues = () => {
  ...
  data.experience = 'Power BI Developer';
...
if (data.group !=='') {
 ...
 if(data.group === 'Development & Engineering' && data.experience === 'Infrastructure Engineer' && data.level === 'Mid Level'){
    ...
    bar.style.width='50%' 
    }else if(data.group === 'Development & Engineering' && data.experience === 'Power BI Developer' && data.level === 'Mid Level'){
    price.textContent = '2,500'
    total.textContent = '2,500'
    median.textContent = '2,500'
    min.textContent = '1,500'
    max.textContent = '2,900'
    candidatesSalary.textContent = '2,000'
    teilursFee.textContent = '500'
    bar.style.width = '50%'
    }else if(data.group === 'Development & Engineering' && data.experience === 'Power BI Developer' && data.level === 'Senior Level'){
    ...
    bar.style.width = '50%'
    }else if(data.group === 'Development & Engineering' && data.experience === 'Power BI Developer' && data.level === 'Manager/Director Level'){
    price.textContent = '4,200'
    total.textContent = '4,200'
    median.textContent = '4,200'
    min.textContent = '3,000'
    max.textContent = '5,000'
    candidatesSalary.textContent = '3,360'
    teilursFee.textContent = '840'
    bar.style.width = '50%'
